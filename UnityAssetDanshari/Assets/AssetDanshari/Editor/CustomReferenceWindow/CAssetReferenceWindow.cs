...
{
    public class CAssetReferenceWindow : AssetBaseWindow
    {
        private void Awake()
        {
        ...
        {
            m_AssetTreeModel = new CAssetReferenceTreeModel();
            m_AssetTreeView = new CAssetReferenceTreeView(m_TreeViewState, multiColumnHeader, m_AssetTreeModel);
        }
