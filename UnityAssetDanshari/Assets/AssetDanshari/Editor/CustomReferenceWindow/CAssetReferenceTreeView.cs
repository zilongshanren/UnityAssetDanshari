...
{
    public class CAssetReferenceTreeView : AssetTreeView
    {
        private CAssetReferenceTreeModel model { get; set; }

        public CAssetReferenceTreeView(TreeViewState state, MultiColumnHeader multiColumnHeader, AssetTreeModel model) : base(state, multiColumnHeader, model)
        {
            this.model = model as CAssetReferenceTreeModel;
        }
